...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; within a project.
   dotspacemacs-startup-lists '((agenda . 5) (recents . 5)
                                (projects . 7))
   ...
   dotspacemacs-themes '(doom-one leuven spacemacs-dark
                         spacemacs-light)
